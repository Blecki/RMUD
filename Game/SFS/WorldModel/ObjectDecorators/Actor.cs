...
namespace SFS
{
    ...
    public partial class MudObject
    {
        public void Actor()
        {
            ...
            GetProperty<NounList>("nouns").Add("MAN", (a) => a.GetProperty<Gender>("gender") == SFS.Gender.Male);
            GetProperty<NounList>("nouns").Add("WOMAN", (a) => a.GetProperty<Gender>("gender") == SFS.Gender.Female);
        }
